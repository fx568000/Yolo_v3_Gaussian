...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_path', default='yolov3.cfg',
                        help='Path to Darknet cfg file.')
    parser.add_argument('--weights_path', default='yolo.weights',
                        help='Path to Darknet weights file.')
    parser.add_argument('--output_path', default='model_data/yolo.h5',
