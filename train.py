...
def create_generators(args):
    """
    Create generators for training and validation.创建用于培训和验证的生成器。
    ...
    # create random transform generator for augmenting training data 创建用于扩充训练数据的随机变换生成器
    ...
    if args.dataset_type == 'pascal': # 数据形式 训练与验证
...
def main(args=None):
    ...
    train_generator, validation_generator = create_generators(args) # 训练与验证数据生成器
